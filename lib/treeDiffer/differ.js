...
treeDiff.differ = function ( tree1, tree2 ) {
...
treeDiff.differ.prototype.getDiff = function ( tree1, tree2, transactions, indicesToTransactions ) {
...
treeDiff.differ.prototype.getNodeDistance = function ( node1, node2 ) {
...
treeDiff.differ.prototype.getTransactions = function ( keyRoot1, keyRoot2, iNulls, jNulls, orderedNodes1, orderedNodes2, transactions ) {
...
// Given a set of transactions and the lengths of two trees, finds the nodes that correspond
treeDiff.differ.prototype.getCorrespondingNodes = function ( transactions, oldTreeLength, newTreeLength ) {
	var i, j, rem, ins,
		oldToNew = {},
		newToOld = {},
		remove = [],
