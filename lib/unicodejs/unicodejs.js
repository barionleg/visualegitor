/*!
 * UnicodeJS I0f1f6568f9055776f2fed90140c04e7e420ddba6
...
( function () {
	 ...
	 * STerm - Unambiguous sentence termination character, like "?" (U+003F QUESTION MARK)
	 * ATerm - Ambiguous sentence termination character, like "." (U+002E FULL STOP)
	 * Close - Close brackets, close quotes etc
	 * Sp - whitespace
	 * As an exception, the text end is a sentence boundary even if there is no STerm|ATerm
	 *
	 * @param {string} text Text to analyze
	 * @return {Object[]} Sentence boundaries
	 * @return {number} i.startIndex The start of the boundary region
	 * @return {number} i.endIndex The end of the boundary region
	 * @return {boolean} i.ambiguous Is the sentence terminating punctuation ambiguous
	 * @return {Object[]} i.content The text that forms the boundary
	 * @return {Object} i.content.j.type Text type, saTerm|close|sp
	 * @return {Object} i.content.j.value Text value ('' if absent)
	 */
