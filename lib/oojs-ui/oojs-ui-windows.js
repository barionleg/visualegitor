...
/**
 * Get properties for all sizes.
 *
 * The default implementation returns a built-in constant, but subclasses can override to provide custom sizes.
 *
 * @returns {Object} Map of symbolic size name to size properties.
 */
OO.ui.Window.prototype.getSizeMap = function () {
	return this.manager.constructor.static.sizes;
};
