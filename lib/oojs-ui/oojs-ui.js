 ...
 * @param {jQuery} [$frame] Frame of the document context if different from top-level frame
 ...
 *
 * If the window is isolated, the visiblity property will be used instead of display.
 *
...
OO.ui.Window.prototype.toggle = function ( show ) {
	...
	if ( show !== this.isVisible() ) {
		...
		if ( this.isolated && ( !this.loading || this.loading.state() === 'pending' ) ) {
...
OO.ui.Window.prototype.load = function () {
	...
	this.dir = OO.ui.Element.getDir( this.$iframe ) || 'ltr';
...
OO.ui.TextInputMenuWidget.prototype.position = function () {
	...
	if ( this.input.$.$frame && this.input.$.context !== this.$element[0].ownerDocument ) {
		frameOffset = OO.ui.Element.getRelativePosition(
			this.input.$.$frame, this.$element.offsetParent()
		);
