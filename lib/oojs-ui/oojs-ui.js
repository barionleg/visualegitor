 ...
 *
 * Date: Tue May 13 2014 16:43:38 GMT-0700 (PDT)
 */
( function ( OO ) {
 ...
 *
 * If a function returns a promise, the next step in the process will not be taken until the promise
 * is resolved.
 *
 * @class
 *
...
OO.ui.Process.prototype.execute = function () {
	...
	function proceed( step ) {
		return function () {
			...
			} else if ( typeof result !== 'object' || !$.isFunction( result.promise ) ) {
				// Use resolved promise for other non-promise results
				return $.Deferred().resolve().promise();
			} else {
 ...
 *   it returns a promise the process will continue to the next step when the promise is resolved or
...
OO.ui.GroupWidget.prototype.setDisabled = function ( disabled ) {
	...
	// Parent method
	// Note: We are calling this constructor assuming this class is mixed into a subclass of
	// OO.ui.Widget
