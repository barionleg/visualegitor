 ...
 *
 * Date: Tue Mar 04 2014 14:47:23 GMT-0800 (PST)
 */
( function () {
 ...
 * @cfg {string} [size='medium'] Symbolic name of dialog size, `small`, `medium` or `large`
 */
 ...
 * Set dialog size.
 *
 * @param {string} [size='medium'] Symbolic name of dialog size, `small`, `medium` or `large`
 */
