 ...
 *
 * Sizing of windows is specified using symbolc names which are interpreted by the window manager.
	...
	preparing.done( OO.ui.bind( function () {
		...
		setTimeout( OO.ui.bind( function () {
			win.setup( data ).then( OO.ui.bind( function () {
				this.opening.notify( { 'state': 'setup' } );
				setTimeout( OO.ui.bind( function () {
					win.ready( data ).then( OO.ui.bind( function () {
						this.opening.notify( { 'state': 'ready' } );
						this.opening = null;
