 ...
 *
 * Date: Thu Jun 19 2014 11:38:54 GMT-0700 (PDT)
 */
( function ( OO ) {
...
var messages = {
	...
	'ooui-dialog-message-default-accept': 'OK',
	// Default label for the reject button of a confirmation dialog
	'ooui-dialog-message-default-reject': 'Cancel',
	// Title for action dialog errors
	'ooui-dialog-action-error': 'Something went wrong',
	// Label for action dialog dismiss button, visible when listing errors
	'ooui-dialog-action-dismiss': 'Dismiss',
	// Label for action dialog try again button, visible when listing recoverable errors
	'ooui-dialog-action-retry': 'Try again'
};
...
OO.ui.Window = function OoUiWindow( config ) {
	...
	// Events
	this.frame.on( 'load', OO.ui.bind( function () {
		this.initialize();
...
OO.ui.Window.prototype.initialize = function () {
	...
	// Initialization
	this.frame.$content.append( this.$head, this.$body, this.$foot, this.$overlay );
...
/**
 * Navigate regressively when the escape key is pressed.
 *
 * @static
 * @abstract
 * @inheritable
 * @property {boolean}
 */
OO.ui.Dialog.static.regressOnEscape = true;
...
OO.ui.Dialog.prototype.initialize = function () {
	...
	// Events
	if ( this.constructor.static.regressOnEscape ) {
 ...
 *
 * @param {boolean} [visible] Make widget visible, omit to toggle visibility
 * @fires visible
 * @chainable
 */
OO.ui.Widget.prototype.toggle = function ( visible ) {
	visible = !!visible;
 ...
 * @param {Object} [config] Configuration options
 */
OO.ui.ModalDialog = function OoUiModalDialog( config ) {
	// Parent constructor
	OO.ui.ModalDialog.super.call( this, config );
	...
	// Initialization
	this.$element.addClass( 'oo-ui-modalDialog' );
};

/* Setup */

OO.inheritClass( OO.ui.ModalDialog, OO.ui.Dialog );
 ...
 */
OO.ui.ModalDialog.prototype.onWindowMouseWheel = function () {
	return false;
};
 ...
 * @param {jQuery.Event} e Key down event
 */
OO.ui.ModalDialog.prototype.onDocumentKeyDown = function ( e ) {
	switch ( e.which ) {
 ...
 * @inheritdoc
 */
OO.ui.ModalDialog.prototype.initialize = function () {
	// Parent method
	OO.ui.ModalDialog.super.prototype.initialize.call( this );

	// Initialization
	this.frame.$content.addClass( 'oo-ui-modalDialog-content' );
};

/**
 * @inheritdoc
 */
OO.ui.ModalDialog.prototype.getSetupProcess = function ( data ) {
	return OO.ui.ModalDialog.super.prototype.getSetupProcess.call( this, data )
		.next( function () {
 ...
 * @inheritdoc
 */
OO.ui.ModalDialog.prototype.getTeardownProcess = function ( data ) {
	return OO.ui.ModalDialog.super.prototype.getTeardownProcess.call( this, data )
		.first( function () {
...
/**
 * Activity dialog window.
 *
 * @abstract
 * @class
 * @extends OO.ui.ModalDialog
 *
 * @constructor
 * @param {Object} [config] Configuration options
 * @cfg {string} [size='large'] Symbolic name of dialog size, `small`, `medium` or `large`
 */
OO.ui.ActionDialog = function OoUiActionDialog( config ) {
	// Configuration initialization
	config = $.extend( { 'size': 'large' }, config );

	// Parent constructor
	OO.ui.ActionDialog.super.call( this, config );
	...
	this.retryNavigationButton = null;
...
OO.inheritClass( OO.ui.ActionDialog, OO.ui.ModalDialog );
 ...
 * @abstract
 * @inheritable
 * @property {string|Function} Label string or function that returns a string
 */
OO.ui.ActionDialog.static.label = null;
 ...
 * @property {Object}
 */
OO.ui.ActionDialog.static.sizes = {
	'small': {
		'width': 400,
		'max-height': 230
	},
 ...
 * @property {string}
 */
OO.ui.ActionDialog.static.defaultSize = 'large';
 ...
 * Hides errors.
 */
OO.ui.ActionDialog.prototype.onDismissButtonClick = function () {
	this.hideErrors();
};
 ...
 */
OO.ui.ActionDialog.prototype.onRetryButtonClick = function () {
	this.hideErrors();
	this.retryHandler();
};
 ...
 */
OO.ui.ActionDialog.prototype.onWindowResize = function () {
 ...
 * @param {jQuery.Event} e Window resize event
 */
OO.ui.ActionDialog.prototype.afterWindowResize = function () {
	this.setSize( this.requestedSize );
};

/**
 * Get dialog naviation.
 *
 * @return {OO.ui.NavigationWidget} Navigation
 */
OO.ui.ActionDialog.prototype.getNavigation = function () {
 ...
 *
 * @param {string} [size='large'] Symbolic name of dialog size, `small`, `medium`, `large` or 'full'
 */
OO.ui.ActionDialog.prototype.setSize = function ( size ) {
	var viewport = OO.ui.Element.getDimensions( this.getElementWindow() ),
	...
	this.size = size;
	this.$element.toggleClass( 'oo-ui-actionDialog-fullscreen', size === 'full' );
	this.$frame.css( sizes[size] );
};

/**
 * Setup navigation.
 *
 * This method is called during the setup process, and is passed the same dialog opening data.
 *
 * @param {Object} [data] Dialog opening data
 */
OO.ui.ActionDialog.prototype.setupNavigation = function () {
...
OO.ui.ActionDialog.prototype.initialize = function () {
	...
	// Properties
	this.navigation = new OO.ui.NavigationWidget( {
		'$': this.$,
		'label': OO.ui.resolveMsg( this.constructor.static.label )
	} );
	this.dismissButton = new OO.ui.ButtonWidget( {
		'$': this.$,
		'label': OO.ui.msg( 'ooui-dialog-action-dismiss' )
	} );
	this.retryButton = new OO.ui.ButtonWidget( {
		'$': this.$,
		'label': OO.ui.msg( 'ooui-dialog-action-retry' )
	} );
	this.$errors = this.$( '<div>' );
	this.$errorsTitle = this.$( '<div>' );

	// Events
	this.navigation.connect( this, { 'accept': 'accept', 'reject': 'reject' } );
	this.dismissButton.connect( this, { 'click': 'onDismissButtonClick' } );
	this.retryButton.connect( this, { 'click': 'onRetryButtonClick' } );

	// Initialization
	this.$errorsTitle
		.addClass( 'oo-ui-actionDialog-errors-title' )
		.text( OO.ui.msg( 'ooui-dialog-action-error' ) );
	this.$errors
		.addClass( 'oo-ui-actionDialog-errors' )
		.append( this.$errorsTitle, this.dismissButton.$element, this.retryButton.$element );
	this.frame.$content
		.addClass( 'oo-ui-actionDialog-content' )
		.append( this.$errors );
	this.$head.append( this.navigation.$element );
};
...
/**
 * Get a process for accepting changes in the dialog.
 *
 * When you override this method, you can add additional accept steps to the process the parent
 * method provides using the 'first' and 'next' methods.
 *
 * @abstract
 * @return {OO.ui.Process} Accept process
 */
OO.ui.Window.prototype.getAcceptProcess = function () {
	return new OO.ui.Process();
};

/**
 * Get a process for rejecting changes in the dialog.
 *
 * When you override this method, you can add additional reject steps to the process the parent
 * method provides using the 'first' and 'next' methods.
 *
 * @abstract
 * @return {OO.ui.Process} Reject process
 */
OO.ui.Window.prototype.getRejectProcess = function () {
	return new OO.ui.Process();
};
 ...
 * Accept changes.
 *
 * After accept process is complete, the dialog will be closed.
 *
 * @return {jQuery.Promise} Promise resolved if accept process is complete or rejected if it fails
 */
OO.ui.ActionDialog.prototype.accept = function () {
	this.pushPending();
	this.retryHandler = OO.ui.bind( this.accept, this );
	this.retryNavigationButton = this.navigation.getAcceptButton();
	return this.getAcceptProcess().execute()
		.always( OO.ui.bind( this.popPending, this ) )
		.then(
			OO.ui.bind( this.close, this, { 'action': 'accept' } ),
			OO.ui.bind( this.showErrors, this )
		);
};
 ...
 * Reject changes.
 *
 * After reject process is complete, the dialog will be closed.
 *
 * @return {jQuery.Promise} Promise resolved if reject process is complete or rejected if it fails
 */
OO.ui.ActionDialog.prototype.reject = function () {
	this.pushPending();
	this.retryHandler = OO.ui.bind( this.reject, this );
	this.retryNavigationButton = this.navigation.getRejectButton();
	return this.getRejectProcess().execute()
		.always( OO.ui.bind( this.popPending, this ) )
		.then(
			OO.ui.bind( this.close, this, { 'action': 'reject' } ),
			OO.ui.bind( this.showErrors, this )
		);
};
...
OO.ui.ActionDialog.prototype.pushPending = function () {
	// Parent method
	OO.ui.ActionDialog.super.prototype.pushPending.call( this );

	this.navigation.setDisabled( this.isPending() );
...
OO.ui.ActionDialog.prototype.popPending = function () {
	// Parent method
	OO.ui.ActionDialog.super.prototype.popPending.call( this );
 ...
 */
OO.ui.ActionDialog.prototype.showErrors = function ( errors ) {
	...
	for ( i = 0, len = errors.length; i < len; i++ ) {
		...
		$errorItem = this.$( '<div>' ).addClass( 'oo-ui-actionDialog-error' );
	...
	if ( recoverable ) {
		this.retryButton.clearFlags().setFlags( this.retryNavigationButton.getFlags() );
	} else {
		this.retryNavigationButton.setDisabled( true );
	}
 ...
 * Hide errors.
 */
OO.ui.ActionDialog.prototype.hideErrors = function () {
	this.$errors.hide();
...
OO.inheritClass( OO.ui.MessageDialog, OO.ui.ModalDialog );

/* Static Properties */

OO.ui.MessageDialog.static.name = 'message';

OO.ui.MessageDialog.static.defaultOpeningData = {
	'title': '',
	'message': '',
	'actions': [
		{
			'action': 'reject',
			'label': OO.ui.deferMsg( 'ooui-dialog-message-default-reject' )
		},
		{
			'action': 'accept',
			'label': OO.ui.deferMsg( 'ooui-dialog-message-default-accept' ),
			'flags': 'primary'
		}
	]
};
...
/**
 * Handle actions choose events.
 *
 * @param {OO.ui.ActionOptionWidget} item Chosen item
 */
OO.ui.MessageDialog.prototype.onActionsChoose = function ( item ) {
	if ( item && this.isOpened() ) {
		this.close( { 'action': item.getAction() } );
	}
};
...
OO.ui.MessageDialog.prototype.initialize = function () {
	...
	// Properties
	this.scrollPanel = new OO.ui.PanelLayout( { '$': this.$, 'scrollable': true } );
	this.textPanel = new OO.ui.PanelLayout( {
		'$': this.$, 'padded': true, 'classes': [ 'oo-ui-messageDialog-textPanel' ]
	} );
	this.title = new OO.ui.LabelWidget( {
		'$': this.$, 'classes': [ 'oo-ui-messageDialog-title' ]
	} );
	this.message = new OO.ui.LabelWidget( {
		'$': this.$, 'classes': [ 'oo-ui-messageDialog-message' ]
	} );
	this.actions = new OO.ui.ActionSelectWidget( {
		'$': this.$, 'classes': [ 'oo-ui-messageDialog-actions' ]
	} );

	// Events
	this.actions.connect( this, { 'choose': 'onActionsChoose' } );

	// Initialization
	this.frame.$content.addClass( 'oo-ui-messageDialog-content' );
	this.scrollPanel.$element.append( this.textPanel.$element );
	this.textPanel.$element.append( this.title.$element, this.message.$element );
	this.$body.append( this.scrollPanel.$element );
...
OO.ui.MessageDialog.prototype.getSetupProcess = function ( data ) {
	...
	return OO.ui.MessageDialog.super.prototype.getSetupProcess.call( this, data )
		.next( function () {
			...
			data = $.extend( {}, this.constructor.static.defaultOpeningData, data );
			this.title.setLabel( data.title );
			this.message.setLabel( data.message );
			this.actions.clearItems();
			for ( i = 0, len = data.actions.length; i < len; i++ ) {
				items.push( new OO.ui.ActionOptionWidget(
					i, $.extend( { '$': this.$ }, data.actions[i] )
				) );
			}
			this.actions.addItems( items );
		}, this );
};
...
OO.ui.MessageDialog.prototype.getReadyProcess = function ( data ) {
	...
	return OO.ui.MessageDialog.super.prototype.getReadyProcess.call( this, data )
		.next( function () {
			this.actions.fitItems();
			this.$frame.css(
				'height', this.textPanel.$element.outerHeight() + this.$foot.outerHeight()
			);
			this.$body.css( {
				'bottom': this.$foot.outerHeight()
			} );
		}, this );
};
/**
 ...
 * @constructor
 * @param {Object} [config] Configuration options
 * @cfg {Object} [acceptButton] Configuration options for the accept button, omit to hide
 * @cfg {Object} [rejectButton] Configuration options for the reject button, omit to hide
 */
OO.ui.NavigationWidget = function OoUiNavigationWidget( config ) {
	// Config intialization
	config = config || {};

	// Parent constructor
	OO.ui.NavigationWidget.super.call( this, config );

	// Mixin constructors
	OO.ui.LabeledElement.call( this, this.$( '<span>' ), config );

	// Properties
	this.$accept = this.$( '<div>' );
	this.$reject = this.$( '<div>' );
	this.$location = this.$( '<div>' );
	this.acceptButton = new OO.ui.NavigationButtonWidget( $.extend(
		true,
		{ 'classes': [ 'oo-ui-navigationWidget-acceptButton' ] },
		config.acceptButton || {},
		{ '$': this.$ }
	) );
	this.rejectButton = new OO.ui.NavigationButtonWidget( $.extend(
		true,
		{ 'classes': [ 'oo-ui-navigationWidget-rejectButton' ] },
		config.rejectButton || {},
		{ '$': this.$ }
	) );

	// Events
	this.acceptButton.connect( this, {
		'click': [ 'emit', 'accept' ],
		'resize': 'fitLabel'
	} );
	this.rejectButton.connect( this, {
		'click': [ 'emit', 'reject' ],
		'resize': 'fitLabel'
	} );
	...
	// Initialization
	this.acceptButton.toggle( !!config.acceptButton ).setNavigation( this );
	this.rejectButton.toggle( !!config.rejectButton ).setNavigation( this );
	this.$accept
		.addClass( 'oo-ui-navigationWidget-accept' )
		.append( this.acceptButton.$element );
	this.$reject
		.addClass( 'oo-ui-navigationWidget-reject' )
		.append( this.rejectButton.$element );
	this.$location
		.addClass( 'oo-ui-navigationWidget-location' )
		.append( this.$label );
	this.$element
		.addClass( 'oo-ui-navigationWidget' )
		.append( this.$reject, this.$location, this.$accept );
};

/* Setup */

OO.inheritClass( OO.ui.NavigationWidget, OO.ui.Widget );
OO.mixinClass( OO.ui.NavigationWidget, OO.ui.LabeledElement );
 ...
 */
OO.ui.NavigationWidget.prototype.onElementAttach = function () {
	this.fitLabel();
};
 ...
 *
 * @return {OO.ui.NavigationButtonWidget} Accept button
 */
OO.ui.NavigationWidget.prototype.getAcceptButton = function () {
 ...
 *
 * @return {OO.ui.NavigationButtonWidget} Reject button
 */
OO.ui.NavigationWidget.prototype.getRejectButton = function () {
 ...
 * @inheritdoc
 */
OO.ui.NavigationWidget.prototype.setDisabled = function ( disabled ) {
	// Parent method
	OO.ui.NavigationWidget.super.prototype.setDisabled.call( this, disabled );

	if ( this.acceptButton && this.rejectButton ) {
		this.acceptButton.updateDisabled();
		this.rejectButton.updateDisabled();
	}
 ...
 * @inheritdoc
 */
OO.ui.NavigationWidget.prototype.setLabel = function () {
	// Mixin method
...
/**
 * Fit label between buttons.
 *
 * @chainable
 */
OO.ui.NavigationWidget.prototype.fitLabel = function () {
	var width,
		$pro = this.acceptButton.$element,
		$reg = this.rejectButton.$element;

	width = Math.max(
		$pro.is( ':visible' ) ? $pro.width() : 0,
		$reg.is( ':visible' ) ? $reg.width() : 0
	);
 ...
 * @param {Object} [config] Configuration options
 */
OO.ui.NavigationButtonWidget = function OoUiNavigationButtonWidget( config ) {
	// Config intialization
	config = $.extend( { 'frameless': true }, config );

	// Parent constructor
	OO.ui.NavigationButtonWidget.super.call( this, config );
	...
	// Events
	this.$button.on( { 'click': OO.ui.bind( this.onClick, this ) } );

	// Initialization
	this.$button
		.append( this.$icon, this.$label );
	this.$element
		.addClass( 'oo-ui-navigationButtonWidget' )
		.append( this.$button );
};

/* Setup */

OO.inheritClass( OO.ui.NavigationButtonWidget, OO.ui.Widget );
OO.mixinClass( OO.ui.NavigationButtonWidget, OO.ui.ButtonedElement );
OO.mixinClass( OO.ui.NavigationButtonWidget, OO.ui.IconedElement );
OO.mixinClass( OO.ui.NavigationButtonWidget, OO.ui.LabeledElement );
OO.mixinClass( OO.ui.NavigationButtonWidget, OO.ui.TitledElement );
OO.mixinClass( OO.ui.NavigationButtonWidget, OO.ui.FlaggableElement );
 ...
 * @fires click
 */
OO.ui.NavigationButtonWidget.prototype.onClick = function () {
	if ( !this.isDisabled() ) {
		this.emit( 'click' );
	}
	return false;
 ...
 * @inheritdoc
 */
OO.ui.NavigationButtonWidget.prototype.isDisabled = function () {
	return this.disabled ||
		( this.navigation instanceof OO.ui.NavigationWidget && this.navigation.isDisabled() );
};

/**
 * Set navigation widget this button is in.
 *
 * @param {OO.ui.NavigationWidget|null} navigation Navigation widget, null if none
 * @chainable
 */
OO.ui.NavigationButtonWidget.prototype.setNavigation = function ( navigation ) {
 ...
 * @chainable
 */
OO.ui.NavigationButtonWidget.prototype.propagateResize = function () {
	var width;
 ...
 * @inheritdoc
 */
OO.ui.NavigationButtonWidget.prototype.setIcon = function () {
	// Mixin method
 ...
 * @inheritdoc
 */
OO.ui.NavigationButtonWidget.prototype.setLabel = function () {
	// Mixin method
	OO.ui.LabeledElement.prototype.setLabel.apply( this, arguments );
	this.propagateResize();
 ...
 * @inheritdoc
 */
OO.ui.NavigationButtonWidget.prototype.setFlags = function () {
	// Mixin method
 ...
 * @inheritdoc
 */
OO.ui.NavigationButtonWidget.prototype.clearFlags = function () {
	// Mixin method
 ...
 * @chainable
 */
OO.ui.NavigationButtonWidget.prototype.toggle = function () {
	// Parent method
	OO.ui.NavigationButtonWidget.super.prototype.toggle.apply( this, arguments );
	this.propagateResize();
 ...
 */
OO.ui.ActionOptionWidget = function OoUiActionOptionWidget( data, config ) {
	// Parent constructor
	OO.ui.ActionOptionWidget.super.call( this, data, config );

	// Properties
	this.action = config.action || '';

	// Initialization
	this.$element.addClass( 'oo-ui-actionOptionWidget' );
};

/* Setup */

OO.inheritClass( OO.ui.ActionOptionWidget, OO.ui.OptionWidget );
 ...
 * @return {string}
 */
OO.ui.ActionOptionWidget.prototype.getAction = function () {
	return this.action;
};
/**
 * List of actions.
 *
 * Use together with OO.ui.ActionOptionWidget.
 *
 * @class
 * @extends OO.ui.SelectWidget
 * @mixins OO.ui.FlaggableElement
 ...
 * @param {Object} [config] Configuration options
 */
OO.ui.ActionSelectWidget = function OoUiActionSelectWidget( config ) {
	// Parent constructor
	OO.ui.ActionSelectWidget.super.call( this, config );

	// Mixin constructors
	OO.ui.FlaggableElement.call( this, config );

	// Initialization
	this.$element.addClass( 'oo-ui-actionSelectWidget' );
};

/* Setup */

OO.inheritClass( OO.ui.ActionSelectWidget, OO.ui.SelectWidget );
OO.mixinClass( OO.ui.ActionSelectWidget, OO.ui.FlaggableElement );

/* Methods */

/**
 * Fit items into columns or rows.
 *
 * Columns will be used if all labels can fit without overflow, otherwise rows will be used.
 *
 * @return {[type]} [description]
 */
OO.ui.ActionSelectWidget.prototype.fitItems = function () {
	var i, len, item,
		useColumns = OO.ui.bind( function ( value ) {
		this.$element
			.toggleClass( 'oo-ui-actionSelectWidget-rows', !value )
			.toggleClass( 'oo-ui-actionSelectWidget-columns', value );
	}, this );
	...
	for ( i = 0, len = this.items.length; i < len; i++ ) {
		item = this.items[i];
		if ( item.$element.innerWidth() < item.$label.outerWidth() ) {
			useColumns( false );
			break;
		}
	}
 ...
 * @inheritdoc
 */
OO.ui.PopupWidget.prototype.toggle = function ( visible ) {
	visible = !!visible;

	var change = visible !== this.isVisible();

	// Parent method
	OO.ui.PopupWidget.super.prototype.toggle.call( this, visible );
