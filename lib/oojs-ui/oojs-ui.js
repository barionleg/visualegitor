 ...
 *
 * Date: Fri Jun 06 2014 16:11:32 GMT-0700 (PDT)
 */
( function ( OO ) {
...
OO.ui.Window = function OoUiWindow( config ) {
	...
	// Initialization
	this.$element
		.addClass( 'oo-ui-window oo-ui-window-closed' )
...
OO.ui.Window.prototype.close = function ( data ) {
	...
	if ( this.opening && this.opening.state() === 'pending' ) {
		window.console.log( 'relay' );
		close = OO.ui.bind( function () {
			window.console.log( 'boing' );
...
OO.ui.Dialog.prototype.setSize = function ( size ) {
	...
	this.$element.addClass( 'oo-ui-dialog-instant' );
	...
	this.$element.removeClass( 'oo-ui-dialog-instant' );
};
