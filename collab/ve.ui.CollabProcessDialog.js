...
ve.ui.CollabProcessDialog.prototype.getSetupProcess = function ( data ) {
	return ve.ui.CollabProcessDialog.super.prototype.getSetupProcess.call( this, data )
		.next( function () {
			this.stack.setItem( this.initPanel );
		}, this );
};
