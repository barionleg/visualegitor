 ...
 * @return return.node {Node|null} The node, or null if we stepped past the root node
 * @return return.offset {number|null} The offset, or null if we stepped past the root node
 * @return return.steps {Object[]} Steps taken {node: x, type: leave|cross|enter|internal, offset: n}
 */
