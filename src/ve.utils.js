 ...
 * @return {Object|null} Change information, or null if unchanged
 * @return {number} return.start Offset from start of first changed element (in both sequences)
 * @return {number} return.end Offset from end of last changed element (in both sequences)
 */
ve.findSequenceChanges = function ( before, after, equals ) {
	var len, start, end;
	if ( !equals ) {
		equals = function ( x, y ) {
			return x === y;
