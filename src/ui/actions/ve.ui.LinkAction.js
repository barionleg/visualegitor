...
ve.ui.LinkAction.prototype.autolinkUrl = function () {
	...
	// Eliminate trailing punctuation, but include ')' in punctuation set
	// only if linktext doesn't have '(', so that URLs with embedded
	// matched parentheses autolink nicely.
	punct = /\(/.test( linktext ) ? /[,;.:!?]+$/ : /[,;.:!?)]+$/;
