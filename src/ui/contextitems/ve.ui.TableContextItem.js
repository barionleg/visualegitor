...
ve.ui.TableContextItem = function VeTableContextItem() {
	...
	this.$title.remove();
	this.$info.remove();
	this.editButton.toggleFramed( false );
...
ve.ui.DeleteColumnContextItem.prototype.getTitle = function () {
	...
	return OO.ui.deferMsg( 'visualeditor-table-delete-col', colCount );
};
...
ve.ui.DeleteRowContextItem.prototype.getTitle = function () {
	...
	return OO.ui.deferMsg( 'visualeditor-table-delete-row', rowCount );
};
