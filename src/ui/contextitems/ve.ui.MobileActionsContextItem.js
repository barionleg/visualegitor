...
ve.ui.MobileActionsContextItem.prototype.onDeleteButtonClick = function () {
	// Use the ContentAction#remove with a key parameter as this triggers
	// the KeyDownHandler for the current selection, e.g. ve.ce.TableDeleteKeyDownHandler
	// will be used to clear table cells for TableSelection's.
	this.context.getSurface().execute( 'content', 'remove', 'backspace' );
