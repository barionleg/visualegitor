...
ve.ui.AuthorListPopupTool.prototype.setup = function ( surface ) {
	...
	this.selfItem.input.connect( this, {
		change: 'onSelfItemChange',
		colorChange: 'onSelfItemColorChange'
	} );
...
/**
 * Handle color change events from the user's authorItem
 *
 * @param {string} color
 */
ve.ui.AuthorListPopupTool.prototype.onSelfItemColorChange = function ( color ) {
