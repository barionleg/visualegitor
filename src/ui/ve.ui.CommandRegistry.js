...
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'insertRowBefore', 'table', 'insert',
		{ data: ['row', 'before'], supportedSelections: ['table'] }
	)
);
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'insertRowAfter', 'table', 'insert',
		{ data: ['row', 'after'], supportedSelections: ['table'] }
	)
);
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'deleteRow', 'table', 'delete',
		{ data: ['row'], supportedSelections: ['table'] }
	)
);
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'insertColumnBefore', 'table', 'insert',
		{ data: ['col', 'before'], supportedSelections: ['table'] }
	)
);
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'insertColumnAfter', 'table', 'insert',
...
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'tableCellHeader', 'table', 'changeCellStyle',
		{ data: ['header'], supportedSelections: ['table'] }
	)
);
ve.ui.commandRegistry.register(
	new ve.ui.Command( 'tableCellData', 'table', 'changeCellStyle',
