 ...
 *
 * Implementations should be aware that fragment may have expanded
 * since it was created so it should be collapsed before inserting
 * content to avoid unwanted deletions.
 *
