...
ve.ui.SpecialCharacterDialog.static.actions = [
	{
		action: 'cancel',
...
/**
 * Set the disabled state of the dialog
 *
 * @param {boolean} disabled Disable the dialog
 */
ve.ui.SpecialCharacterDialog.prototype.setDisabled = function ( disabled ) {
	if ( disabled !== this.disabled ) {
		this.disabled = disabled;
		this.$body.toggleClass( 've-ui-specialCharacterDialog-disabled', this.disabled );
	}
};
...
ve.ui.SpecialCharacterDialog.prototype.buildButtonList = function () {
	...
	this.$body.append(
		this.bookletLayout.$element,
		this.$( '<div>' ).addClass( 've-ui-specialCharacterDialog-shield' )
	);
};
