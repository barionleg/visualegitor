...
ve.ui.FindAndReplaceDialog.static.size = 'wide';
...
ve.ui.FindAndReplaceDialog.prototype.initialize = function () {
	...
	this.$findResults = this.$( '<div>' ).addClass( 've-ce-surface-findResults' );
	this.fragments = [];
...
ve.ui.FindAndReplaceDialog.prototype.positionResults = function () {
	...
	for ( i = 0, l = this.fragments.length; i < l; i++ ) {
		...
		$result = this.$( '<div>' ).addClass( 've-ce-surface-findResult' );
		top = Infinity;
		for ( j in rects ) {
...
ve.ui.FindAndReplaceDialog.prototype.highlightFocused = function ( scrollIntoView ) {
	...
	this.$findResults.find( '.ve-ce-surface-findResult-focused' ).removeClass( 've-ce-surface-findResult-focused' );
