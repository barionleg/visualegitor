...
ve.ui.FindAndReplaceDialog.prototype.initialize = function () {
	...
	// Events
	this.onWindowScrollThrottled = ve.throttle( this.onWindowScroll.bind( this ), 250, { trailing: true } );
	this.updateFragmentsThrottled = ve.throttle( this.updateFragments.bind( this ), 250, { trailing: true } );
	this.renderFragmentsThrottled = ve.throttle( this.renderFragments.bind( this ), 250, { trailing: true } );
