 ...
 */
ve.ui.CompletionWidget.prototype.setup = function ( action, fromTrigger ) {
 ...
 *
 * @param {boolean} [withSequence] Inlcude the triggering sequence text in the range
 * @return {ve.getRange|null} Range, null if not valid
 */
