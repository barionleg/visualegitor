 ...
 * @inheritdoc
 */
ve.ce.BranchNode.prototype.initialise = function () {
	// Parent method
	ve.ce.BranchNode.super.prototype.initialise.apply( this, arguments );
 ...
 * wrapper, subscribe to the 'teardown' and 'setup' events, or over-ride #initialise.
 *
 * @method
 * @fires teardown
 * @fires setup
...
ve.ce.BranchNode.prototype.updateTagName = function () {
	...
	if ( tagName !== this.tagName ) {
		...
		// Give sub-classes the opportunity to touch the new element
		this.initialise();
		this.emit( 'setup' );
	}
};
