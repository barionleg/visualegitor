...
ve.ce.Document.prototype.getNodeAndOffset = function ( offset, outsideNail ) {
	...
	if (
		...
		return { node: nao.node, offset: nao.offset - 1 };
	} else if ( outsideNail && ( previousNode.classList.contains( 've-ce-nail' ) && nao.offset === 0 ) ) {
	...
	} else if ( outsideNail && ( nextNode.classList.contains( 've-ce-nail' ) && nao.offset === currentNode.length ) ) {
