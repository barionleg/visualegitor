 ...
 * @return return.anchorNode {Node} The anchor node
 * @return return.anchorOffset {number} The anchor offset
 * @return return.focusNode {Node} The focus node
 * @return return.focusOffset {number} The focus offset
 * @return return.isCollapsed {boolean} True if the focus and anchor are in the same place
 * @return return.isBackwards {boolean} True if the focus is before the anchor
 */
