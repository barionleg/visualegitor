 ...
 *
 * @param {HTMLNode[]} elements Clipboard HTML elements
 * @returns {string} Hash
 */
ve.ce.Surface.static.getClipboardHash = function ( elements ) {
	var i, l, element, hash = '';
	...
	for ( i = 0, l = elements.length; i < l; i++ ) {
		...
		if ( element.nodeType === Node.TEXT_NODE ) {
			...
			hash += '<' + element.nodeName + '>' + this.getClipboardHash( element.childNodes );
		}
	}
