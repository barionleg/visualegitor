 ...
 *
 * "Cursor-equivalent positions" are positions that the browser does not fully distinguish
 * for cursoring purposes, e.g. 'a|<b>c' and 'a<b>|c'. They can have different effects when
 * editing (in this case, whether the text appears bolded or not).
 *
