...
ve.ce.Surface = function VeCeSurface( model, ui, options ) {
	...
	this.getElementDocument().on( 'focusin focusout', this.onDocumentFocusInOutHandler );
...
ve.ce.Surface.prototype.destroy = function () {
	...
	this.getElementDocument().off( 'focusin focusout', this.onDocumentFocusInOutHandler );
