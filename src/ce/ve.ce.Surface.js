...
ve.ce.Surface.prototype.updateActiveAnnotations = function () {
	...
	activeAnnotations.forEach( function ( annotation ) {
		...
		if ( surface.activeAnnotations.indexOf( annotation ) ) {
			annotation.toggleActive( true );
			changed = true;
		}
	} );
 ...
 *
 * @return {ve.ce.Annotation[]} The annotation containing the focus
 */
