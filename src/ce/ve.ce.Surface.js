...
ve.ce.Surface.prototype.showModelSelection = function () {
	var selection, changed, modelRange, nativeImpliedModelRange;
	...
	if ( this.documentView.documentNode.$element.get( 0 ).contains(
		...
		nativeImpliedModelRange = new ve.Range(
			ve.ce.getOffset(
				this.nativeSelection.anchorNode,
		...
		if ( selection.getModel().getRange().equals( nativeImpliedModelRange ) ) {
