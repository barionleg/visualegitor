...
ve.ce.Surface.prototype.onActiveAnnotationsChange = function () {
	...
	// If we're inside a unicorn, then it's guaranteed we don't need to change the surface
	if ( this.unicorningNode && this.unicorningNode === this.getSelectedContentBranchNode() ) {
		return;
	}
...
ve.ce.Surface.prototype.renderSelectedContentBranchNode = function () {
	...
	return contentBranchNode.renderContents();
};
