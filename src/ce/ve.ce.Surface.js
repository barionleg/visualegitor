 ...
 */
ve.ce.Surface.prototype.onDocumentSelectionChange = function ( e ) {
	if ( !this.dragging ) {
		// Optimisation
		return;
	}
	this.fixupCursorPosition( 0, e.shiftKey );
...
ve.ce.Surface.prototype.handleInsertion = function () {
	...
	if ( !range.isCollapsed() ) {
		...
		if (
			!this.documentView.rangeInsideOneLeafNode( range ) ||
 ...
 *
 * @return {boolean} True if the selection splits a link
 */
