...
ve.ce.Surface.prototype.showSelectionState = function ( selection ) {
	...
	if ( $focusTarget.get( 0 ) === this.getElementDocument().activeElement ) {
		...
		// IE <= 11: focusing already-focused elements scrolls the *top* of
		// the element into view, meaning that in long text blocks refocusing
		// the current element will jump the viewport around.
