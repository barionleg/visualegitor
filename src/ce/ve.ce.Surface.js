...
ve.ce.Surface.prototype.afterDocumentKeyDown = function ( e ) {
	var isArrow, offset1, offset2, crossedNode, fixupCursor;
	...
	if (
		...
		try {
			offset1 = ve.ce.getOffset(
				this.nativeSelection.focusNode,
				this.nativeSelection.focusOffset
			);
			offset2 = ve.ce.getOffset(
				this.misleadingCursorStartSelection.focusNode,
...
ve.ce.Surface.prototype.handleLinearArrowKey = function ( e ) {
	...
	/*jshint bitwise:false */
		...
		// leftarrow in ltr, or rightarrow in rtl. TODO: Sadly, plaintext bidi breaks this.
		direction = -1;
	} else {
		// leftarrow in rtl, or rightarrow in ltr. TODO: Sadly, plaintext bidi breaks this.
		direction = 1;
	}
