...
ve.ce.Surface.prototype.renderSelectedContentBranchNode = function () {
	...
	ceNode = this.documentView.getBranchNodeFromOffset( dmRange.start );
	if ( ceNode === null ) {
		return false;
	}
...
ve.ce.Surface.prototype.onSlugEnter = function () {
	...
	$wrapper.removeClass( 've-ce-branchNode-blockSlugWrapper-former-unfocused' );
};
...
ve.ce.Surface.prototype.moveModelCursor = function ( offset ) {
	this.model.setSelection( this.model.getDocument().getRelativeRange(
...
ve.ce.Surface.prototype.showSelection = function ( range ) {
	var endRange, rangeSelection, nativeRange;
	if ( range === null ) {
		return;
	}
