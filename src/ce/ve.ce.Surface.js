 ...
 * @return.anchorNode {Node} The anchor node
 * @return.anchorOffset {number} The anchor offset
 * @return.focusNode {Node} The focus node
 * @return.focusOffset {number} The focus offset
 * @return.isCollapsed {boolean} True if the focus and anchor are in the same place
 * @return.isBackwards {boolean} True if the focus is before the anchor
 */
