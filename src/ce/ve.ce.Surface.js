...
ve.ce.Surface.prototype.showModelSelection = function () {
	var selection, changed, currentModelRange, newModelRange;
	...
	currentModelRange = selection.getModel().getRange();
	if ( this.documentView.documentNode.$element.get( 0 ).contains(
		...
		if ( currentModelRange.equals( newModelRange ) ) {
			// Current native selection fits model range; don't change
			return false;
		}
	}
	changed = this.showSelectionState( this.getSelectionState( newModelRange ) );
	// Support: Chrome
