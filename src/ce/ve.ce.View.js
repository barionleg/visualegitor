...
/**
 * Initialise `this.$element`. This is called by the constructor, and must be called every time
 * that `this.$element` is replaced.
 */
ve.ce.View.prototype.initialise = function () {
};
