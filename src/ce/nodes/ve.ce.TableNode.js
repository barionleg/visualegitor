...
ve.ce.TableNode.prototype.onSetup = function () {
	...
	this.surface.getModel().getDocument().connect( this, { transact: 'updateOverlay' } );
	this.surface.connect( this, { position: 'updateOverlay' } );
};
...
ve.ce.TableNode.prototype.onTeardown = function () {
	...
	this.surface.getModel().getDocument().disconnect( this, { transact: 'updateOverlay' } );
	this.surface.disconnect( this, { position: 'updateOverlay' } );
	this.$overlay.remove();
};
