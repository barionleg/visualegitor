 ...
 * @param {ve.ce.Surface} surface The surface view
 * @param {boolean} selectionOnly The caller promises the content has not changed from old
 */
ve.ce.RangeState = function VeCeRangeState( old, surface, selectionOnly ) {
	/**
	...
	this.saveState( old, surface, selectionOnly );
};
 ...
 * @param {boolean} selectionOnly The caller promises the content has not changed from old
 */
ve.ce.RangeState.prototype.saveState = function ( old, surface, selectionOnly ) {
	var $node, selection, anchorNodeChanged,
		nativeSelection = surface.nativeSelection,
		documentNode = surface.getDocument().getDocumentNode();
