 ...
 * @param {boolean} oldFocusIsAfterAnnotationBoundary TODO: remove this
 * @param {ve.dm.Surface} dmSurface TODO: remove this
 *
 * @return {Object} Results of analysis
 * @return.transaction {ve.dm.Transaction} Transaction corresponding to the DOM content change
 * @return.rerender {boolean} Whether the DOM needs rerendering after applying the transaction
 */
ve.ce.dmChangeFromContentChange = function ( node, previous, next, oldFocusIsAfterAnnotationBoundary, dmSurface ) {
	...
	if (
		...
		} else if ( oldFocusIsAfterAnnotationBoundary ) {
