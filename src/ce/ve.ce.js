...
/**
 * Get the next non-descendent "edit leaf node" within the current contenteditable CBN
 *
...
ve.ce.nextEditLeaf = function ( node ) {
	...
	// Sadly we can't use node.isContentEditable, because it fails in detached tests
	while (
