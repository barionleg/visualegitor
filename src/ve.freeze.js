...
( function () {
	 ...
	 * @param {Object} [seen] Set of already-seen objects (for internal, recursive use)
	 * @param {Function} [seen.has] Return true if the argument object has already been seen
	 * @param {Function} [seen.add] Mark the argument object as seen
