...
/**
 * A node has been attached with ve.Node#setDocument . Its descendents are guaranteed
 * to be attached too (and the event is emitted for descendents first, and for siblings
...
/**
 * A node has been detached with ve.Node#setDocument . Its descendents are guaranteed
 * to be detached too (and the event is emitted for descendents first, and for siblings
 * in their order in the children list)
 *
 * @event nodeDetached
 ...
 */
ve.Document.prototype.onNodeAttached = function ( node ) {
 ...
 */
ve.Document.prototype.onNodeDetached = function ( node ) {
