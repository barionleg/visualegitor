 ...
 *
 * @constructor
 * @param {ve.FrozenSelection|Selection|Object} selection DOM Selection-like object
 * @param {Node|null} selection.anchorNode the Anchor node
 * @param {number|null} selection.anchorOffset the Anchor offset
 * @param {Node|null} selection.focusNode the Focus node
 * @param {number|null} selection.focusOffset the Focusoffset
