 ...
 *
 * @param {ve.dm.AnnotationSet} annotationSet The annotation set to compare this one to
 * @returns {boolean} The annotation sets are equal
 */
ve.dm.AnnotationSet.prototype.compareToStrict = function ( annotationSet ) {
	var i, len, ourIndexes = this.getIndexes(), theirIndexes = annotationSet.getIndexes();
