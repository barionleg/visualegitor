 ...
 * @param {boolean} [noExpand] Don't expand the selection to include merged cells
 */
ve.dm.TableSelection = function VeDmTableSelection( doc, tableRange, fromCol, fromRow, toCol, toRow, noExpand ) {
	// Parent constructor
...
ve.dm.TableSelection.prototype.clone = function () {
	return new this.constructor( this.getDocument(), this.tableRange, this.fromCol, this.fromRow, this.toCol, this.toRow, true );
};
...
/**
 * Is the table selection covering a full row
 *
 * @return {boolean} The table selection covers a full row
 */
...
/**
 * Is the table selection covering a full column
 *
 * @return {boolean} The table selection covers a full column
 */
