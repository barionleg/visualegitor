...
ve.dm.RebaseClient = function VeDmRebaseClient() {
	...
	/**
	 * @property {number} Offset up to which we know we have no differences with the server
	 */
	this.commitLength = 0;
	...
	/**
	 * @property {number} Number of transactions backtracked (i.e. rejected) since the last send
	 */
	this.backtrack = 0;
};
