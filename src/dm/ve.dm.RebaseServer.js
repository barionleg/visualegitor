 ...
 * @return {Map} return.continueBases Per-author ve.dm.Change of transposed history for rebasing
 * @return {Map} return.rejections Per-author count of unacknowledged rejections
 */
 ...
 * @return {Object|null} New state: Rebased change and updated selections (null if prior conflict)
