 ...
 * @return {Promise<Map.<number,number>>} return.rejections Per-author count of unacknowledged rejections
 */
ve.dm.RebaseServer.prototype.getStateForDoc = ve.async( function* getStateForDoc( doc ) {
