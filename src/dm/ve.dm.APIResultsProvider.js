 ...
 */
ve.dm.APIResultsProvider = function VeDmResourceProvider( config ) {
	config = config || {};
...
/* Setup */
OO.initClass( ve.dm.APIResultsProvider );
 ...
 */
ve.dm.APIResultsProvider.prototype.setAPIurl = function ( url ) {
	this.apiurl = url;
};
