 ...
 * @param {Map.<number,string>} authorNames Display name of each author
 */
ve.dm.RebaseDocState = function VeDmRebaseDocState( history, continueBases, rejections, authorNames ) {
	/**
	...
	this.authorNames = authorNames || new Map();
};
