 ...
 * @return {ve.dm.IndexValueStore} The store items introduced by transaction n
 */
 ...
 *
 * @return {ve.dm.IndexValueStore[]} Each transaction's store items (shallow copied store)
 */
