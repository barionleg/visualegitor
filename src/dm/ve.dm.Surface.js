...
/**
 * Set the storage system for autosave
 *
 * @param {ve.init.SafeStorage} storage Storage system
 */
ve.dm.Surface.prototype.setStorage = function ( storage ) {
	if ( this.storing ) {
		throw new Error( 'Can\'t change storage system after auto-save has stared' );
	}
