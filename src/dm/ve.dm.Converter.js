...
/**
 * Get the DocumentSet for the document we're converting
 *
 * @return {ve.dm.DocumentSet} Associated DocumentSet
 */
...
ve.dm.Converter.prototype.createDataElements = function ( modelClass, domElements ) {
	...
	if ( dataElements.length ) {
		...
		if ( OO.isSubclass( modelClass, ve.dm.BranchNode ) && modelClass.static.childNodeTypes === null ) {
...
ve.dm.Converter.prototype.getModelFromDom = function ( doc, options ) {
	var data, linearData, refData, innerWhitespace, mainDocument, reservation, documentSet,
		store = new ve.dm.IndexValueStore(),
		internalList = new ve.dm.InternalList();

	options = options || {};

	documentSet = new ve.dm.DocumentSet( options.lang, options.dir );
	...
	mainDocument = new ve.dm.Document( linearData, doc, undefined, internalList, innerWhitespace, options.lang, options.dir );
