 ...
 * reference node which contains the reference content (<ref> tags in MediaWiki).
 *
 * This property should not be used for data which isn't out-of-band but is less accessible in
 * the view, e.g. content presented in ve.ce.ActiveNode's such as table cells or image captions.
 *
