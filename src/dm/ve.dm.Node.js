 ...
 * @inheritable
 */
ve.dm.Node.static.isListLike = false;
 ...
 * @inheritable
 */
ve.dm.Node.static.isLeafLike = false;
 ...
 * @inheritdoc ve.Node
 */
ve.dm.Node.prototype.isListLike = function () {
	return this.constructor.static.isListLike;
};

/**
 * @inheritdoc ve.Node
 */
ve.dm.Node.prototype.isLeafLike = function () {
	return this.constructor.static.isLeafLike;
};
