	...
	for ( i = 0, ilen = groups.length; i < ilen; i++ ) {
		...
		switch ( group.action ) {
			case 'diff':
				...
				// Get oldDocInternalListNodes for this group
				...
				// Get newDocInternalListNodes for this group
				...
				// Diff newDocInternalListNodes and oldDocInternalListNodes
				...
				if (
					...
					// Get all items in new doc; mark as unchanged, changed or inserted
			...
			case 'insert':
				...
				// Get newDocInternalListNodes for this group
				// Add to internalListDiffInfo as insert
			...
			case 'remove':
				...
				// Get oldDocInternalListNodes for this group
				// Add to internalListDiffInfo as remove
				internalListDiffInfo[ group.group ] = getInternalListItems(
					oldDocNodeGroups[ group.group ].indexOrder,
					this.oldDocInternalListNode.children,
					-1
