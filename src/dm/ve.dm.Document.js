 ...
 *
 * @param {Function} test Function to test whether a node matches
...
ve.dm.Document.prototype.getNearestFocusableNode = function ( offset, direction, limit ) {
	return this.getNearestNodeMatching( ve.dm.nodeFactory.isNodeFocusable, offset, direction, limit );
};
