...
/**
 * Handle the node's structure being changed.
 *
 * @param {Object} context An Object giving the context of the change.
 * @method
 */
...
/**
 * Get the number of rows, columns, or an array of both of the table.
 *
...
/**
 * Get the TableMatrixRectangle between two cells in the table.
 *
 * @param {ve.dm.TableCellNode} startCellNode The start of the matrix.
 * @param {ve.dm.TableCellNode} endCellNode The end of the matrix.
 * @return {ve.dm.TableMatrixRectangle} The requested TableMatrixRectangle.
 */
