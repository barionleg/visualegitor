...
QUnit.test( 'adjustLinkSelection', function ( assert ) {
	 ...
	 *
	 * @param {ve.SelectionState} sel The selection
	...
	var html, div, ab, cd, cdSpan, ef, gh, tests, i, len, test, orig, elt;
	html = 'AB' +
	...
	tests = [
		...
		{ orig: [ div, 1, div, 2 ], moved: [ div, 1, div, 2 ], msg: 'link inside, div' },
		{ orig: [ cd, 1, cd, 2 ], moved: [ cd, 1, cd, 2 ], msg: 'inside link, text' },
		{ orig: [ cdSpan, 1, cd, 2 ], moved: [ cdSpan, 1, cd, 2 ], msg: 'inside link' },
		// Changing
		{ orig: [ ab, 1, cd, 1 ], moved: [ ab, 1, div, 2 ], msg: 'Grow end, text' },
		{ orig: [ ab, 1, cdSpan, 1 ], moved: [ ab, 1, div, 2 ], msg: 'Grow end, span' },
		{ orig: [ cd, 1, ef, 1 ], moved: [ div, 1, ef, 1 ], msg: 'Grow start, text' },
		{ orig: [ cdSpan, 1, ef, 1 ], moved: [ div, 1, ef, 1 ], msg: 'Grow start, span' },
		{ orig: [ cd, 1, gh, 1 ], moved: [ div, 1, div, 4 ], msg: 'Grow both, text' },
		{ orig: [ cdSpan, 1, gh, 1 ], moved: [ div, 1, div, 4 ], msg: 'Grow both, span' },
		// Directed
		{
			orig: [ ab, 1, cd, 1 ],
			direction: 1,
