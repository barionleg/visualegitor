...
QUnit.test( 'adjustLinkSelection', function ( assert ) {
	...
	tests = [
		...
		// Directed
		{
			...
			direction: 1,
			moved: [ div, 1, div, 4 ],
			msg: 'Grow right at focus from pre-open nail'
		},
		{
			orig: [ div, 1, div, 2 ],
			direction: -1,
			moved: [ div, 1, div, 1 ],
			msg: 'Shrink left at focus from pre-open nail'
		},
		{
			orig: [ div, 3, div, 4 ],
			direction: 1,
			moved: [ div, 4, div, 4 ],
			msg: 'Shrink right at anchor from post-open nail'
		},
		// TODO: this one does not look right
		{
			orig: [ div, 3, div, 4 ],
			direction: -1,
			moved: [ div, 4, div, 4 ],
			msg: 'Shrink right at focus from post-open nail'
		},
		{
			orig: [ ab, 1, cd, 1 ],
			direction: 1,
