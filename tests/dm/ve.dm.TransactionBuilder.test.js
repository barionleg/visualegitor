...
QUnit.test( 'Replace metadata', function ( assert ) {
	var html = '<ul><li><p>foo</p></li><li></li></ul><p></p><div><div><meta></div></div><ul><li><p>bar</p></li></ul>',
		doc = ve.dm.converter.getModelFromDom( ve.createDocumentFromHtml( html ) ),
		tx = ve.dm.TransactionBuilder.static.newFromRemoval( doc, new ve.Range( 4, 25 ) );
	assert.ok( !tx, 'Check what the tx looks like' );
} );
