		...
		.then( function ( data ) {
			...
			queue.get( 10 )
				.then( function ( data ) {
					...
					// two were marked as depleted. We asked for 10, the queue fetched
					// 12 more from provider 1, adding to the 3 we already had.
					// The queue returned 10 results as requested, which left 5
