...
QUnit.test( 'onTransact', function ( assert ) {
	...
	// Subtract 4 for the 2 removed meta items (only relevant for the first assert, not for the rollback)
	QUnit.expect( cases.length * ( 8 * doc.metadata.getTotalDataLength() + 2 ) - 4 );
