...
ve.dm.TreeModifier.prototype.dump = function () {
	...
	lines.push( 'adjusted inserter: ' + JSON.stringify( this.getInserterPosition() ) );
	lines.push( 'adjusted remover: ' + JSON.stringify( this.getRemoverPosition( {
...
QUnit.test( 'treeDiff', function ( assert ) {
	var origData, tx, treeDiff, surface, doc, treeModifier, i, iLen, j;

	// old: <div><p>foobarbaz</p><p>qux</p></div><p>quux</p><p>
	// new: <ul><li><p>foo</p><p>barBAZ</p><p>qux</p></li></ul><p>quux</p><p><img src='x'></p>
	// tx: {-<div>-|+<ul><li>+}<p>foo{+</p><p>+}bar{-baz-|+BAZ+}</p><p>qux</p>{-</div>-|+</li></ul>+}<p>q{-uu-|+UU+}x</p>{+<img src='x'>+}
	origData = [
		{ type: 'div' },
		{ type: 'paragraph' },
		'f',
