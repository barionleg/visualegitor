...
// Fake socket class, with limited query API, that stores a single collection in memory
/**
 * @constructor
 * @param {Object} io Fake IO object
 * @param {Object} query Query parameters
 */
ve.dm.FakeSocket = function VeDmFakeSocket( io, query ) {
