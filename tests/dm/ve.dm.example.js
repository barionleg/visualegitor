...
ve.dm.example.domToDataCases = {
	...
	'heading containing two paragraphs (as generated by content editable)': {
		body: '<h2><p>Foo</p><p>Bar</p></h2>',
		data: [ /* something more sensible than a heading containing two inline aliens */ ]
	}
};
