...
module.exports = function ( grunt ) {
	...
	grunt.registerMultiTask( 'buildloader', function () {
		...
		function styleTag( src ) {
			var ltrCss, rtlCss, rtlFilepath;

			if ( janus ) {
				ltrCss = grunt.file.read( src.file );
				rtlCss = cssjanus.transform( ltrCss, true );
				rtlFilepath = 'dist/' + src.file.replace( /\.css$/, '.rtl.css' ).replace( /\//g, '-' );

				if ( ltrCss !== rtlCss ) {
					rtlCss  = '/* This file is GENERATED by cssjanus. DO NOT EDIT. */\n\n' + rtlCss;
					grunt.file.write( rtlFilepath, rtlCss );
				...
				} else if ( grunt.file.exists( rtlFilepath ) ) {
					grunt.file.delete( rtlFilepath );
				}
			}
