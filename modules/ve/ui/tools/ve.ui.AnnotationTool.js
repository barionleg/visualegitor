...
* @param {Object} [config] Configuration options
*/
ve.ui.BigAnnotationTool = function VeUiSuperscriptAnnotationTool( toolGroup, config ) {
	ve.ui.AnnotationTool.call( this, toolGroup, config );
};
...
ve.ui.BigAnnotationTool.static.icon = 'big';
...
* @param {Object} [config] Configuration options
*/
ve.ui.SmallAnnotationTool = function VeUiSuperscriptAnnotationTool( toolGroup, config ) {
	ve.ui.AnnotationTool.call( this, toolGroup, config );
};
...
ve.ui.SmallAnnotationTool.static.icon = 'small';
