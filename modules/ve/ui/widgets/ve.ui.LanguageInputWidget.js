...
ve.ui.LanguageInputWidget = function VeUiLanguageInputWidget( config ) {
	...
	var findLangaugeField, languageCodeField, directionField, surface, searchDialog;
	...
	// Initialization
	findLangaugeField = new OO.ui.FieldLayout( this.findLanguageButton, {
			'$': this.$,
			'align': 'left',
	...
	this.$element
		...
		.append( findLangaugeField.$element, languageCodeField.$element, directionField.$element );
