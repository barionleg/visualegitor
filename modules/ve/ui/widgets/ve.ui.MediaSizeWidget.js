...
ve.ui.MediaSizeWidget = function VeUiMediaSizeWidget( scalable, config ) {
	...
	this.sizeTypeSelectWidget.addItems( [
		...
		// Parsoid is not yet implemented 'upright'; when it is implemented
...
*/
	...
	// TODO: Add support for units in OO.ui.FieldLayout
 ...
 * @param {string} item Selected size type item
...
/**
 * Get the values of the placeholders in the dimensions widget
 * @param {Object} placeholders The width and height values of the placeholders
 */
 ...
 * @return {Object} dimensions Height and width placeholders
 */
 ...
 *
 * @param {Object} givenDimensions Height and width placeholders
 * @fires change
 */
