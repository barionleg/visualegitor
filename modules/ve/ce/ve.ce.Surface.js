...
ve.ce.Surface.prototype.handleInsertion = function () {
	...
	if ( !selection.isCollapsed() ) {
		...
		if ( !this.selectionInsideOneNode( selection ) ) {
			this.model.change(
...
/**
 * Test whether selection lies within a single node
 * @param {ve.Range} selection The selection to test
 * @returns {boolean} Whether the selection lies within a single node
 */
ve.ce.Surface.prototype.selectionInsideOneNode = function ( selection ) {
